		...
		<div css="padding: 0 .3rem 1rem; max-width: 600px; margin: 0 auto;">
			...
			>
				<div css="display: flex; align-items: center; justify-content: center">
					...
					<div>
						<div css="font-weight: bold; font-size: 280%; margin-bottom: .3rem">
							<span css="width: 6rem; text-align: right; display: inline-block">
								{Math.round(value / 1)}
							</span>{'    '}
							   kg CO2e
						</div>
				...
				<div css="display: flex; flex-direction: column;">
					<ShareButton
						text="Mesure ton empreinte avec WeNR Light !"
						url={window.location}
						title={'WeNR Light'}
						color={textColor}
